...
class MainMap(object):
    ...
    Name = MainMap_Name('MainMap.Name', 1)
    SqBracket1 = MainMap_SqBracket1('MainMap.SqBracket1', 2)
    Zero = MainMap_Zero('MainMap.Zero', 3)
    ElemNum = MainMap_ElemNum('MainMap.ElemNum', 4)
    SqBracket2 = MainMap_SqBracket2('MainMap.SqBracket2', 5)
    Equal = MainMap_Equal('MainMap.Equal', 6)
    Brace1 = MainMap_Brace1('MainMap.Brace1', 7)
    Number = MainMap_Number('MainMap.Number', 8)
    Comma = MainMap_Comma('MainMap.Comma', 9)
    Brace2 = MainMap_Brace2('MainMap.Brace2', 10)
    Error = MainMap_Error('MainMap.Error', 11)
    OK = MainMap_OK('MainMap.OK', 12)
